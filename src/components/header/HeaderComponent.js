...
function HeaderComponent() {
    ...
    switch (true) {
        case currentItem === SLUGS.dashboard:
            title = 'Dashboard';
            break;
        case [SLUGS.Data, SLUGS.referenceData].includes(currentItem):
            title = 'Data';
            break;
        case currentItem === SLUGS.projects:
            title = 'Projects';
            break;
        case [SLUGS.transforms, SLUGS.dataLineage].includes(currentItem):
            title = 'Transforms';
            break;
        case currentItem === SLUGS.Builds:
            title = 'Builds';
            break;
        ...
        <Row className={classes.container} vertical='center' horizontal='space-between'>
            ...
            <Row vertical='center'>
                ...
                <DropdownComponent
                    label={
                        <>
                            <span className={classes.name}>Abhishek Verma</span>
                            <img
